...
void mapWorkspacesToMonitors()
{
    ...
    int keepFocused = std::any_cast<Hyprlang::INT>(HyprlandAPI::getConfigValue(PHANDLE, k_keepFocused)->getValue());
    int workspaceCount = std::any_cast<Hyprlang::INT>(HyprlandAPI::getConfigValue(PHANDLE, k_workspaceCount)->getValue());
